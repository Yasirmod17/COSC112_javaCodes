public class GregorianDate {
    ...
    /* this method changes the date in special ways, for example if dates were dropped 
     * when converting to the Gregorian Calendar.  It should return true if it changed
