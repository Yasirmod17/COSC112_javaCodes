...
public class SPackNumberChangeListener implements ActionListener {

	private SixPackGame game;
    private int j;
    private int i;
    private JButton b;
    public SPackNumberChangeListener(JButton clicker,SixPackGame fr,int i,int j) {
		game = fr;
		this.j=j;
		this.i=i;
		this.b=clicker;
