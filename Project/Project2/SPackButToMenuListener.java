...
public class SPackButToMenuListener implements ActionListener {
    ...
    public SPackButToMenuListener(SixPackGame Game, JButton clicker,int i,int j) {
		myButton = clicker;
    		
		// create a popup menu
		menu = new JPopupMenu("Menu");
		SPackNumberChangeListener scl = new SPackNumberChangeListener(myButton,Game,i,j);
